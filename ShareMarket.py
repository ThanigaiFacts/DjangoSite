...
def CalculateAveragePrice(request):
    if request.method == 'POST':
        FirstBuyQty = request.POST.get('FirstBuyQty')
        FirstBuyPrice = request.POST.get('FirstBuyPrice')
        SecondBuyQty = request.POST.get('SecondBuyQty')
        SecondBuyPrice = request.POST.get('SecondBuyPrice')
...
def ShareMarketData(request):
    if request.method == 'POST':
        ordertype = request.POST.get('ActionList')
        CompanyName = request.POST.get('CompanyName')
        BuyQty = request.POST.get('BuyQty')
